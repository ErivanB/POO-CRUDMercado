...
public class TelaAutenticacaoAlmoxarifeView extends JFrame {
    private JTextField loginField;
    private JPasswordField senhaField;
    private JButton autenticarButton;
    private JButton cancelarButton;

    AlmoxarifeController controller;

    public TelaAutenticacaoAlmoxarifeView(AlmoxarifeController controller) {
        this.controller = controller;
        setTitle("Login de Almoxarife");
        setSize(300, 100);
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    if (gerenteAutenticado) {
                        ...
                        dispose();
                        TelaFuncoesAlmoxarife telaFuncoesAlmoxarife = new TelaFuncoesAlmoxarife();
                        telaFuncoesAlmoxarife.setVisible(true);
