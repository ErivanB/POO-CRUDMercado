...
public class TelaAutenticacaoGerenteView extends JFrame {
    ...
    public TelaAutenticacaoGerenteView(GerenteController controller) {
        this.controller = controller;
        setTitle("Login de Gerente");
        setSize(300, 100);
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    if (gerenteAutenticado) {
                        ...
                        TelaFuncoesGerenteView telaFuncoesGerente = new TelaFuncoesGerenteView();
                        telaFuncoesGerente.setVisible(true);
