        ...
        cadastrarButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    Gerente novoGerente = new Gerente(nomeField.getText(), loginField.getText(), new String(senhaField.getPassword()), emailField.getText(), nisPisField.getText());

                    // Verifica se o gerente é válido.
                    if (controller.isValidaGerente(novoGerente)) {
