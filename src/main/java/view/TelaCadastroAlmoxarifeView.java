...
public class TelaCadastroAlmoxarifeView extends JFrame {
    ...
    public TelaCadastroAlmoxarifeView(AlmoxarifeController controller) {
    ...
    private void initialize() {
        ...
        cadastrarButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    // Coleta os dados e cria um Almoxarife.
                    Almoxarife novoAlmoxarife = new Almoxarife(nomeField.getText(), loginField.getText(), new String(senhaField.getPassword()), emailField.getText(), nisPisField.getText());

                    // Verifica se o gerente é válido.
                    if (controller.isValidaAlmoxarife(novoAlmoxarife)) {
                        ...
                        if (response == JOptionPane.YES_OPTION) {
                            ...
                            controller.cadastrarAlmoxarife(novoAlmoxarife);
